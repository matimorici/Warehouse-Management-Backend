...
-- ============================================================================
-- REFERENCIA (histórico, ya NO se ejecuta a mano).
-- La fuente de verdad del schema es ahora la migración de Flyway:
--   src/main/resources/db/migration/V1__create_schema.sql
-- Flyway la aplica automáticamente al arrancar la aplicación, así que NO
-- hace falta correr este script a mano en bases nuevas ni existentes.
-- ============================================================================
