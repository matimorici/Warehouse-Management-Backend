...
- [X] **Unmapped tables documented in V1 (review point 2).** `ubicacion`, `valoracion_proveedor`, `orden_compra`, `linea_compra`, `movimiento_fisico` have no JPA entities yet — added an inline comment in `V1__create_schema.sql` stating they're part of the full domain design, reserved for planned features (don't drop).
